...
class FreeReportFormViewModel extends ChangeNotifier {
  ...
  Report _buildFreeReport(String title) {
  ...
  Future<bool> processFreeReport(String email) async {
    isLoading = true;
    notifyListeners();
    try {
      ...
      final Report report = _buildFreeReport(prompt.prompt);
