...
* “Agreement” means ticking the box acknowledging that you agree to these terms and conditions when purchasing an GEO MAX report from the website.

1. GEO MAX REPORT
1.1 Users requesting an GEO MAX Report
a. If you upload your personal and business details to create a GEO MAX Report:
i. you must ensure that such information is true and correct;
ii. you must ensure that such information is up to date at the time they are uploaded and are kept up to date for the duration of the time they are used by the website to produce the GEO MAX Report;
iv.  you will comply with all applicable laws when using the information provided by GEO MAX.
b. If you use the reports in a way that breaches these Terms and Conditions, GEO MAX may take action to remedy this, including but not limited to, amending or deleting the Reports, adjusting access to your Account, terminating your Account or any other action that we determine appropriate in our sole and absolute discretion.
c. GEO MAX may delete, deactivate or edit any Reports or Accounts that breach our Terms and Conditions or are, in the opinion of GEO MAX, inappropriate, but we are not obligated to do so.
...
b. To create a report you must register (Account) with GEO MAX by providing personal information (name and email address) and business information (Business Name, description of business and business URL) and pay the required fee for the report requested.
c. You must be 18 years or older in order to register an Account and create a Report on our Website.
d. You represent and warrant that the information you provide to GEO MAX to open an Account is true and correct. If, at any time during the term of your Account, any of that information ceases to be true and correct, you undertake to notify GEO MAX of the change to that information as soon as is reasonably practicable.
e. Any personal information you provide to GEO MAX will be treated in accordance with GEO MAX's privacy policy (available here). 
f. You may not use another user's Account, or allow anyone else to use your Account, without GEO MAX's express prior written permission.
g. You are solely responsible for any activity which occurs on your Account.
h. You must keep your Account details, including your password and other verification details, secure at all times and must immediately notify GEO MAX of any breach, or any suspected breach, of the security of or unauthorised access to your Account.
2.2 Security checks
All accounts on GEO MAX are subject to security checks. When using the platform, you agree to be subject to these security checks, which may delay the activation of your account.
2.3 Termination
GEO MAX may, in its absolute discretion, suspend or terminate your Account if:
a. you breach or violate any term or condition of these Terms and Conditions of Use; or
b. in GEO MAX's sole opinion, your ongoing use of the Service will bring, or may bring, the reputation of GEO MAX into disrepute or cause GEO MAX to be in breach of an applicable law.
c. in GEO MAX's reasonable opinion, your ongoing use of the Service may pose a threat to the health, safety or wellbeing of any GEO MAX user or others within the community.

3. WEBSITE
3.1 Use of Website
You must not, and must not attempt to:
a. use the Website for any purpose other than for the purpose of producing an GEO MAX report for your business;
...
g. cause GEO MAX to lose (in whole or in part) the services of GEO MAX's internet service providers (ISPs) or other suppliers;
...
GEO MAX will attempt to make the Website available for use 24 hours a day, 7 days a week. However, it will be necessary for GEO MAX to take-down the Website and cease providing the Services for a period of time for regular maintenance and to make improvements and if circumstances beyond GEO MAX's control exist, such as problems preventing access to internet or webhosting services. In such circumstances GEO MAX will incur no liability to you for such interruption or cessation of Services no matter how such liability would otherwise arise.

4. Report Content
4.1 Intellectual Property and Use of Reports
All content, scoring methodologies, analytics, and report outputs provided through the GEO MAX website (including but not limited to your GEO MAX, performance breakdowns, recommendations, and visualizations) are and shall remain the exclusive property of Real Estate AI Pty Ltd or its licensors.
By accessing or using the platform, you acknowledge and agree that:
You are granted a non-exclusive, irrevocable, worldwide, royalty-free license to use, reproduce, display, and distribute your individual GEO MAX report(s) for the sole purpose of improving your visibility, ranking, and credibility across digital platforms, including but not limited to AI search tools, real estate marketplaces, social media, and your own marketing channels.
...
4.2 Release
You forever release GEO MAX, and its directors, officers, employees, agents and contractors, for any and all claims, rights, demands, actions or suits which you have, may have or would have had, in connection with GEO MAX's Report Content or the exploitation of the Content by any of GEO MAX or its directors, officers, employees, agents or contractors and whether that claim arose or arises in contract, tort (including, without limitation, negligence), under statute or otherwise.
4.3 Waiver
You hereby consent to all acts or omissions by GEO MAX, its licensees or others authorised by it, or its successors in title, which would otherwise constitute an infringement of any moral rights you have, or may have, in the Content or any part of it, or any material appearing in the Content, whatsoever and wheresoever subsisting throughout the world. You acknowledge that such consent is provided genuinely and includes consent for GEO MAX, or any other person authorised by GEO MAX, to materially alter, modify, add to and in any way change the Content or any part of it, or any material appearing in the Content, and deal with the Content or any part of it, or any material appearing in the Content, without identifying you or any third person as the author of the Content or any part of the Content, or any material appearing in the Content. You warrant that any third party who has acquired any moral rights in the Content or any part of it, or any material appearing in the Content, has also waived his or her moral rights or consented to all acts or omissions (as applicable) on terms similar to the terms set out in these Terms and Conditions of Use.
4.4 Access to and use of Content and correspondence by GEO MAX
GEO MAX may access, read, and permanently store any correspondence made by you to GEO MAX, including by email, post, or other messaging service, for the purposes of protecting the safety and security of the website and its users. The correspondence made by you to GEO MAX may be used as the basis for removing your Content from the Website, terminating your Account, or reporting behaviour to any government law enforcement authorities.
...
b. You acknowledge and agree that you are permitted to use the Website and Report Content only as set out in these Terms and Conditions of Use or as otherwise expressly authorised in writing by GEO MAX, and that you may not otherwise copy, reproduce, transmit, publicly perform, distribute, commercially exploit, adapt, translate, modify, bundle, merge, share or make available to any person, or create derivative works of the Website and Report Content.
c. Subject to your compliance with these Terms and Conditions of Use, you may reproduce or communicate any Website or Report Content appearing in any articles or blog posts appearing on the Website that have been posted by GEO MAX as long as (i) you credit GEO MAX as the source of any such content and provide a link to the Website when reproducing or communicating such content, and (ii) your use is either personal use for a non-commercial purpose or fair and reasonable commercial use, to be determined at our discretion.

6. TAKE-DOWN NOTICE
GEO MAX operates on a “notice and takedown basis”. If you have any objections or complaints to any content or material appearing on the Website or if you believe that content or material posted on the Platform, Website, and/or Paid Social Media Advertisements infringes your copyright, please contact us immediately at justin@reai.au.

7. LIMITATION OF LIABILITY
7.1 Website
Use of the Website is at your own risk. Both are provided on an “as is” basis, and GEO MAX makes no representation, and gives no warranty or guarantee (to the extent permitted by law), as to its function or operation, or that it is free from any defects.
7.2 Competition and Consumer Act
If the Competition and Consumer Act 2010 (Cth) or any other Act (including, without limitation, equivalent country, state or territory legislation) implies into these Terms and Conditions of Use any term, or otherwise provides that any guarantee applies in relation to the services supplied under or in connection with these Terms and Conditions of Use, which, or the effect of which, cannot be excluded or modified, and if we breach such term, condition, warranty or guarantee, then GEO MAX's liability (if permitted by the relevant Act) is limited, at GEO MAX's election, to the re-supplying of the relevant services, a refund of the cost of having those services supplied or payment of the cost of having the services re-supplied.
7.3 Limitation
Subject to clause 7.1 above, and to the extent permitted by law, GEO MAX shall not have any liability whatsoever (whether in contract, tort including negligence, pursuant to statute or otherwise) to you for any direct or indirect loss or damage of whatsoever kind you suffer or incur as a result of, or in any way in connection with, your use of the Website, or which otherwise arises in connection with your dealings with GEO MAX.

8. INDEMNITY
You indemnify GEO MAX and its directors, officers, employees, agents and contractors, and agree to keep each of them fully indemnified, from and against any loss, claim or damages (including, without limitation, any costs (including legal costs) on a full indemnity basis) suffered, incurred or brought against any one or more of them by a third party as a result of any breach by you of clauses 1.1(a)(i)-(ii), 3.1 and 4.2 of these Terms and Conditions of Use or arising out of any other negligent act, omission or wilful misconduct by you in connection with your use of the Website, including but not limited to the following circumstances:
...
b. any loss, claim or damages suffered by a third party as a result of any infringement of any rights of a third party including, without limitation, Intellectual Property Rights in any information, material or Content that you upload to the Website or provide to GEO MAX;
c. any loss, claim or damages suffered by a third party as a result of any act or default committed by you and which is directly or indirectly related to any information, material or Content that you or another person upload to the Website or provide to GEO MAX or your use of the Website; or 
